  ...
  return (
    <div>
      ...
      <div className="todocenter d-flex   justify-content-between ms-5 me-3 p-5">
        ...
        <label>
          <span className="fw-bold fs-5">Status Filter :&nbsp;&nbsp;</span>
          <select
            name="status"
            id="filtervalue"
            value={filtervalue}
          ...
          >
            <option value="All" className="bg-danger color-white">
              All
            </option>
            <option value="Completed" className="bg-success color-white">
              Completed
            </option>
            <option value="notCompleted" className="bg-danger color-white ">
              Not-Completed
            </option>
          </select>
        </label>
        ...
        <div className="row row-cols-lg-3   row-cols-md-2 row-cols-sm-1 d-flex justify-content-between  ">
          {filteredTodos.map((element, index) => {
            return (
              <div key={element.id}>
                <div
                  className="card-body card p-3 mt-3"
                  style={{ width: "24rem" }}
                >
                  ...
                  <div className="row mt-2 mb-3">
                    <span>
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          handleStatus(element.id, e.target.value)
                        }
                      >
                        <option value="false" className="bg-danger ">
                          Not-Completed
                        </option>
